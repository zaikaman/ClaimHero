...
The repository includes 1,346 automated tests across 86 suites, covering the
Convex workflows, authorization boundaries, OCR/redaction, vault-tokenized
PHI-safe LLM boundaries, context-aware evidentiary rebuttal rehydration and prerequisite study date resolution without diagnostic contradictions, fail-closed outbound placeholder transmission gates, Firecrawl and AgentMail integrations, precedent
