...
export const CommandDialog: React.FC<CommandDialogProps> = ({
  ...
  const allActions: CommandAction[] = useMemo(
    () => [
      ...
      {
        id: "action-studio",
        label: "Appeal Studio (Legal Brief)",
      ...
      {
        id: "action-p2p",
        label: "Doctor P2P Tele-Script",
        description: "3-minute peer-to-peer physician rebuttal script & medical director cheat sheet",
        icon: PhoneCall,
        category: "workspace",
        categoryLabel: "Active Case Workspace",
        keywords: [
      ...
      },
      {
        ...
        label: "Financial & ERISA Calculator",
        description: "Patient out-of-pocket exposure & $110/day statutory penalty calculator",
        icon: Calculator,
        category: "workspace",
        categoryLabel: "Active Case Workspace",
        keywords: [
