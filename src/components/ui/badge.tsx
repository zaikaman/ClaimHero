...
export function Badge({
  ...
  const baseStyles =
    "inline-flex shrink-0 items-center justify-center gap-1 overflow-hidden rounded-md border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-all select-none [&>svg]:size-3";
