...
export const SIMULATION_STAGES = [
  ...
  },
  {
    stage: 3,
    id: "matching",
    title: "Precedent Cross-Examination & Readiness Audit",
    description: "Cross-matching clinical evidence against 3 winning precedents -> 91/100 Statutory Appeal Readiness",
    durationMs: 3000,
  },
  {
    stage: 4,
